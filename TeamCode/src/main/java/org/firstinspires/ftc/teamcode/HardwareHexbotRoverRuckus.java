...
public class HardwareHexbotRoverRuckus {
  ...
  //----------------------------------------------------------------------------------------------
   public void tankDrive(double drivePower, double robotAngle, double rotPwr,long duration)//Autonomous
   {
  ...
  public void tankDrive(double drivePower, double robotAngle, double rotPwr)//TeleOp
  {
    double angleInRad = robotAngle*(Math.PI/180);
