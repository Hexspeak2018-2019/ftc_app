...
@Autonomous(name = "SunSanTesting", group = "Linear")

public class SunSanTesting extends LinearOpMode {
    ...
    final static double inch = 115.2;
...
//        public static double MoveAngle(double degrees) {
//
//            double radians = Math.toRadians(degrees);
//
//            double yValue = Math.sin(radians);
//            double xValue = Math.cos(radians);
//
//            float xValue = xValue;
//            float yValue = yValue;
//
//            float topLeftSpeed = (-xValue + yValue);
//            float topRightSpeed = (-xValue - yValue);
//            float bottomLeftSpeed = (-xValue + yValue);
//            float bottomRightSpeed = (-xValue - yValue);
//            }
//
    }
}
